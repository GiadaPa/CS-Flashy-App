...
//--------------------------------------------------------------------------------------
//Function to handle the exercise continuation with the incorrect before the correct cards
    exerciseAgainNewSort = () => {
        if(this.state.incorrectList.length === 0){
            ...
            this.props.cards = this.state.incorrectList + this.state.correctList
        }
        //console.log(this.state.correctList, this.state.incorrectList)
                    ...
                    this.state.showRes ? (    
                        <View>
                            ...
                            <Button title="GO TO DECK OF INCORRECT CARDS"
                                    color='cyan'
                                    onPress={this.exerciseAgainNewSort}
                                    />
